...
def main(args):
    ...
    new_header = fits.Header({"RA" : ra, "DEC" : dec, "DATE-OBS" : date_obs, "EXPOSURE" : exposure,"COMMENT" : "metafits generated by steve, as it is required by the shift-stack pipeline"})
