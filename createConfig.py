...
def getIntialGuess(result, obs_dayofyear, args):
...
def main(args):
    ...
    yaml_file = getIntialGuess(result, obs_dayofyear, args)

    ## write to file
    with open("auto_created_delta_" +str(args.deltaGuess)+ "_config" + str(args.noradid) + ".yaml" , "w") as output_file:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--deltaGuess", type=float,default=0, help="the delta time offset for obtaining the initial guess")
